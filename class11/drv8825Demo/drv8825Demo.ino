...
void loop() {
  ...
  Serial.println("Now 3 second per Revolution without microstepping");
  ...
  Serial.println("Now 3 second per Revolution with 4 microstepping");
  ...
  Serial.println("Now 3 second per Revolution with 32 microstepping");
  ...
  Serial.println("Now 0.5 second per Revolution without microstepping");
  stepper.setMicrostep(1);
  stepper.setRPM(120);
  stepper.enable();
  delay(10);
